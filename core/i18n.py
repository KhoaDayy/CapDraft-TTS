...
_VI = {
    ...
    "window_title": "CapDraft TTS — Tạo TTS cho project CapCut", "capcut_project": "Project CapCut", "choose_project": "Chọn project", "project_placeholder": "Chọn thư mục project hoặc draft_content.json…", "reload_project": "Tải lại project", "export_srt": "Xuất SRT", "split_project": "Tách 2 phần", "merge_videos": "Ghép video", "no_project": "Chưa chọn project",
